...
function About() {
    return (
        <div >
            <Header />
            <ul className="Guarantees" type="circle">
                <li className="Guarantee">
                    Мы доставляем кигуруми по всей России уже 10 лет
                </li>
                <li className="Guarantee">
                    Доставка зарубеж производится за счёт покупателя, который в праве выбрать способ отправки
                </li>

                <li className="Guarantee">
                    Гарантируем качетство и гарантию производства
                </li>

                <li className="Guarantee">
                    Нашими клиентами являются Владимир Владимирович Путин и все его клоны
                </li>
